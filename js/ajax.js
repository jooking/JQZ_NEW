...
(function(w){
	...
	w.ajax_register = function(options){
		var data = getdata(options,'com.jqz.user.register');
		mui.ajax(httpUrl,{
			data:data,
			dataType:'json',//服务器返回json格式数据
			type:'post',//HTTP请求类型
	...
	w.ajax_login = function(options){
		var data = getdata(options,'com.jqz.user.login');
		mui.ajax(httpUrl,{
			data:data,
			dataType:'json',//服务器返回json格式数据
			type:'post',//HTTP请求类型
			...
			error:function(xhr,type,errorThrown){
				console.log("登录失败:"+errorThrown.toString());
			}
		});
	}
	...
	w.ajax_change_pwd = function(options){
		var data = getdata(options,'com.jqz.user.change_pwd');
		mui.ajax(httpUrl,{
			data:data,
			dataType:'json',//服务器返回json格式数据
			type:'post',//HTTP请求类型
	...
	w.ajax_logout = function(options){
		var data = getdata(options,'com.jqz.user.loginout');
		mui.ajax(httpUrl,{
			data:data,
			dataType:'json',//服务器返回json格式数据
			type:'get',//HTTP请求类型
	...
	w.ajax_get_likelist = function(options){
		startLoad();
		var data = getdata(options,'com.jqz.user.collect_list');
		mui.ajax(httpUrl,{
			data:data,
			dataType:'json',//服务器返回json格式数据
			type:'get',//HTTP请求类型
	...
	w.ajax_delete_likeItem = function(options){
		startLoad();
		var data = getdata(options,'com.jqz.user.delete_collect');
		mui.ajax(httpUrl,{
			data:data,
			dataType:'json',//服务器返回json格式数据
			type:'get',//HTTP请求类型
